...
if (isset($_POST['btnLog'])){
		...
		$sql = "SELECT * FROM cleaner WHERE CleanerEmail='$Email'";
		...
		if($num_rows == 0){
			echo "<script>alert('Email is not Recognized!! Try Signing Up')
      window.history.back();</script>";
		...
		//num_rows not equal to 0 // user existed
				...
				$pw = $record['CleanerPassword'];//hashed password in the table
...
<body>
    ...
    <div class="container admin-container">
        <div class="form-container">
          <center>
        <img src="img/cleaner.png" alt="">
        </center>
            <div class="login-header">Welcome Back Cleaner</div><br>
            <form method="POST">
            ...
            <div class="form-link">
                <p>Not registered? <a href="CleanerReg.php">Register here</a></p>
            </div>
        </div>
    </div>
